(function() {
  ...
  const config = {
  "timestamp": "2025-11-16T08:57:15.432Z",
  "repo": {
    "user": "somiibo",
    "name": "soundcloud-booster-website"
  },
  ...
  "config": {
    "source": "dist",
    "destination": "/home/runner/work/soundcloud-booster-website/soundcloud-booster-website/_site",
    "collections_dir": "",
    ...
    "url": "https://soundcloudbooster.com",
    "theme": {
      "id": "classy",
      "target": "frontend",
      "appearance": "dark",
    ...
    "meta": {
      "title": "SoundCloud Bot - Get real followers, plays, likes, reposts, and comments - {{ site.brand.name }}",
      "description": "Automate your SoundCloud activity with this free like bot, follow bot & play bot. {{ site.brand.name }} is a follow bot and play generator all in one. Increase SoundCloud followers & plays for free!",
    ...
    "brand": {
      ...
      "description": "Automate your SoundCloud for free",
      "type": "Corporation",
      "images": {
    ...
    "cloudflare": {
      "zone": "03cbb630b3cb2c0b97abcf9d30570e3a"
    },
    "download": {
      "mac": {
        "universal": ""
    ...
    "random_id": 25,
    "canonical": {
      "url": "https://soundcloudbooster.com/config.json",
      "path": "/config.json"
    }
  },
  "npm-build": "2025-11-16T08:57:15.432Z"
};
